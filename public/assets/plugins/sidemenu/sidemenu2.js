$(function() {
	"use strict";
	$('.main-sidebar .nav-link.with-sub').on('click', function(e) {
		e.preventDefault();
		$(this).parent().toggleClass('show');
		$(this).parent().siblings().removeClass('show');
		$('body').addClass('main-sidebar-open'); // To open main-sidebar on click on nav-link with-sub
	})
	$('.main-sidebar .nav-link').on('click', function(e) {
		e.preventDefault();
		$(this).parent().siblings().removeClass('show'); // To remove show class from nav-link
	})
